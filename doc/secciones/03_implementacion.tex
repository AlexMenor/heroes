...
En primer lugar tenemos que decidir entre un sistema P2P o uno con arquitectura de cliente-servidor.
...
\section{Backend}
La mayoría de la lógica de la aplicación está en este componente, por lo que descartamos un BaaS, que sería más apropiado en el caso de un cliente 
...
He decidido usar \textbf{Typescript} \cite{typescript}, que es un lenguaje de tipado gradual que transpila a Javascript.
